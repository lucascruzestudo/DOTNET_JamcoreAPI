...
public class CreateTrackPlayCommandValidator : AbstractValidator<CreateTrackPlayCommand>
{
    public readonly CultureLocalizer _localizer;
    private readonly IRepositoryBase<Track> _trackRepository;
    public CreateTrackPlayCommandValidator(CultureLocalizer localizer, IRepositoryBase<Track> trackRepository)
    {
